...
<html class="x-admin-sm">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./index.html">后台管理模板</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('个人信息','admin-list.html')">个人信息</a></dd>
                        <dd>
                ...
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('客户列表','Clue/clue_open.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>客户列表</cite></a>
                            </li>
                            <li>
                            <li>
                                <a onclick="xadmin.add_tab('添加新客户','Clue/clue.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加新客户</cite></a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('员工列表','User/user.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>员工列表</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="客户交流">&#xe723;</i>
                            <cite>客户交流</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
